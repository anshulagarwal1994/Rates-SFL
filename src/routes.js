...
// import ScheduleshipmentStep1 from "components/Scheduleshipment/ScheduleshipmentStep1";
// import step2test from "components/Scheduleshipment/step2test";
...
import GetQuoteThankyouDemo from "components/GetQuote/GetQuoteThankyouDemo";
const Components = {
  GetRates: GetRates,
};
...
var dashRoutes = [
  ...
  {
    path: "/new-getRate",
    name: "Get Quote Thank you Demo",
    component: GetQuoteThankyouDemo,
    layout: "/auth",
    invisible: false,
  },
