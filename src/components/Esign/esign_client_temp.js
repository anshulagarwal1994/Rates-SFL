...
class esign_client_temp extends React.Component {
          ...
          if (res.success) {
            ...
            if (res.data.length) {
              ...
              this.setState({
                ...
                MovingBackToIndia : !CommonConfig.isEmpty(fromRes[0].MovingBackToIndia) ? fromRes[0].MovingBackToIndia.data[0] === 0 ? false : true : '',
                NameAsPerPassport : fromRes[0].NameAsPerPassport,
                YearsOutsideIndia : fromRes[0].YearsOutsideIndia,
                StayInIndia : !CommonConfig.isEmpty(fromRes[0].StayInIndia) ? fromRes[0].StayInIndia.data[0] === 0 ? "No" : "Yes" : '',
                LatestArrivalDate : fromRes[0].LatestArrivalDate,
                AppliedForTR : !CommonConfig.isEmpty(fromRes[0].AppliedForTR) ? fromRes[0].AppliedForTR.data[0] === 0 ? "No" : "Yes" : '',
                AbleToProvidePassport: !CommonConfig.isEmpty(fromRes[0].AbleToProvidePassport) ? fromRes[0].AbleToProvidePassport.data[0] === 0 ? "No" : "Yes" : '',
  ...
  trim = () => {
    if(this.validate()){
      ...
      if(this.state.SignType === 'Type'){
        ...
        imgURL = this.sigPad.getTrimmedCanvas().toDataURL('image/png');
      }
  ...
  render(){
      const  { InsuranceType ,  MovingBackToIndia , FromContactName , NameAsPerPassport , YearsOutsideIndia , StayInIndia , 
                LatestArrivalDate , AppliedForTR , AbleToProvidePassport, VisaValidDate , ArrivalCategory , NAText ,
                OpenSignPad ,trimmedDataURL ,SignType,showAlreadySigned,showAlreadyExpired ,showConfirmationPage ,DocumentManagedBy,
                ShowContra ,isFlicker , ManagedByEmail,ExpiredOnDate ,SignedOnDate ,ManagedByName ,SFLContactNumber ,
                SignDate ,InsuranceWaiver , outofPageCount
        } = this.state;
      ...
      return (
        ...
        {!showAlreadySigned && !showAlreadyExpired && !showConfirmationPage && isFlicker ?   
          <>
            ...
            <div class="contaract-table-page font-11">
                ...
                <div class="table-responsive">
                    <table style={{width: '100%', marginTop: '15px'}}>
                        <tbody>
                            <tr>
                                <td colSpan="4" style={{border: '1px solid #000', textAlign: 'center', padding: '5px', fontSize: '13px', fontWeight: 'bold', color: '#fff', background: '#002060'}}>Contract for Overseas Relocation Services</td>
                            </tr>
                        </tbody>
                    </table>
                    <div class="row">
                        <div class="half-col">
                            <table style={{width: '100%'}}>
                                <tbody>
                                    <tr>
                                        <td style={{border: '1px solid #000', width: '30%', padding: '5px'}}><b>Customer Name:</b></td>
                                        <td style={{border: '1px solid #000', width: '70%', padding: '5px'}}>{FromContactName}</td>
                                    </tr>
                                    <tr>
                                        <td style={{border: '1px solid #000', width: '30%', padding: '5px'}}><b>Origin City:</b></td>
                                        <td style={{border: '1px solid #000', width: '70%', padding: '5px'}}>
                                            {this.state.fromCity} - {this.state.FromZipCode}
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style={{border: '1px solid #000', width: '30%', padding: '5px'}}><b>Phone:</b></td>
                                        <td style={{border: '1px solid #000', width: '70%', padding: '5px'}}>
                                            {this.state.FromPhone1}{!CommonConfig.isEmpty(this.state.FromPhone2) ? "," : ""}{this.state.FromPhone2}
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style={{border: '1px solid #000', width: '30%', padding: '5px'}}><b>Est. Volume:</b></td>
                                        <td style={{border: '1px solid #000', width: '70%', padding: '5px'}}>
                                            {this.state.totalCFT} Cft.
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style={{border: '1px solid #000', width: '30%', padding: '5px'}}><b>Commodity:</b></td>
                                        <td style={{border: '1px solid #000', width: '70%', padding: '5px'}}>HHG</td>
                                    </tr>
                                    <tr>
                                        <td style={{border: '1px solid #000', width: '40%', padding: '5px'}} class="mobile-align-left"><b>Insurance:</b></td>
                                        <td style={{border: '1px solid #000', width: '60%', padding: '5px'}}>
                                            {this.state.isVisible ? "Movers Liability" : InsuranceType}
                                        </td>
                        ...
                        <div class="half-col">
                            <table style={{width: '100%'}}>
                                <tbody>
                                    ...
                                    <tr>
                                        <td style={{border: '1px solid #000', width: '40%', padding: '5px', textAlign: 'right'}} class="mobile-align-left"><b>Container Type:</b></td>
                                        <td style={{border: '1px solid #000', width: '60%', padding: '5px'}}>
                                    ...
                                    <tr>
                                        <td style={{border: '1px solid #000', width: '30%', padding: '5px', textAlign: 'right'}}><b>Managed By:</b></td>
                                        <td style={{border: '1px solid #000', width: '70%', padding: '5px'}}>
                                          {DocumentManagedBy}
                                        </td>
                                    </tr>
                    ...
                    <table style={{width: '100%', marginTop: '20px'}}>
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style={{fontWeight: 'bold', padding: '5px', border: '1px solid #000', background: '#ffc000', textAlign: 'right', width: '15%'}}>$ {parseFloat(this.state.TotalInvoiceCost).toFixed(2)}</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
                ...
                <div id="footer-1" class="footer">
                    <div class="f-box">
                        <span>Initial Here: <input disabled={this.state.hideIntital} onChange={(e)=>this.intialHereChange(e,1)} maxlength="10"/></span>
                    </div>
                    ...
                    <div class="f-box right">
                        <span>Page <b>1</b> of <b>{outofPageCount}</b></span>
                    </div>
                </div>
            ...
            <div class="contaract-table-page page">
                ...
                <div id="footer-2" class="footer">
                    <div class="f-box">
                        <span>Initial Here: <input disabled={this.state.hideIntital} onChange={(e)=>this.intialHereChange(e,2)} maxlength="10"/></span>
                    </div>
                    ...
                    <div class="f-box right">
                        <span>Page <b>2</b> of <b>{outofPageCount}</b></span>
                    </div>
                </div>
                ...
                <div class="contaract-table-page page">
                  ...
                  <div class="header">
                    ...
                    <div class="ins-wai-outer">
                      <div class="table-responsive">
                        <table style={{width: '100%', marginTop: '20px'}}>
                            <tbody>
                                <tr>
                                  <td style={{border: '1px solid #000', textAlign: 'center', padding: '5px', fontSize: '20px', fontWeight: 'bold', color: '#fff', background: '#002060'}}>Insurance Waiver</td>
                                </tr>
                                <tr>
                                  <td style={{padding: '5px', border: '1px solid #002060',fontSize:'16px',marginTop: '20px'}}>
                                    
                                    I hereby agree to waive all insurance coverage insurance offered by SFL Worldwide. I understand that any damage incurred during transit or loss of individual packages or loss of the entire shipment will not be covered by SFL Worldwide, or any party affiliated with the handling of my shipment. By signing this form, I waive all rights to subrogation.
                                    <span style={{width:'100%',display:'inline-block',height:'600px'}}>
                    ...
                    <div id={"footer-3"} class="footer">
                      <div class="f-box">
                          <span>Initial Here: <input disabled={this.state.hideIntital} onChange={(e)=>this.intialHereChange(e,4)} maxlength="10"/></span>
                      </div>
                      ...
                      <div class="f-box right">
                          <span>Page <b>{3}</b> of <b>{outofPageCount}</b></span>
                      </div>
                  </div>
                </div>
                  :
            ...
            <div class="contaract-table-page page">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td style={{padding: '5px', border: '1px solid #002060'}}>
                                    ...
                                    <b>Palletization:</b> Palletizing is done for the protection of your cargo and adds up to 30% the volume of your shipment, please factor this in your calculation, Palletization volume cannot be estimated until actual measurement is done.<br/><br/>
                ...
                <div id={InsuranceWaiver === "Yes" ? "footer-4" : "footer-3"} class="footer">
                    <div class="f-box">
                        <span>Initial Here: <input disabled={this.state.hideIntital} onChange={(e)=>this.intialHereChange(e,3)} maxlength="10"/></span>
                    </div>
                    <div onClick={() => this.scrolldiv(InsuranceWaiver === "Yes" ? 5 : 4)} className="flag-label">
                      <span>Sign</span>
                    </div>
                    <div class="f-box-middle">
                        <b>SFL WORLDWIDE LLC | FMC License No.: 025184</b>
                    ...
                    <div class="f-box right">
                        <span>Page <b>{InsuranceWaiver === "Yes" ? 4 : 3}</b> of <b>{outofPageCount}</b></span>
                    </div>
                </div>
            ...
            <div class="contaract-table-page page">
                        ...
                        <table style={{width: '100%', marginTop: '20px'}}>
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style={{border: '1px solid #000', padding: '5px', textAlign: 'left', width: '50%'}}>
                                        {MovingBackToIndia ?  LatestArrivalDate ? moment(LatestArrivalDate).format(CommonConfig.dateFormat.dateOnly) : '' : NAText}
                                    </td>
                                </tr>
                                <tr>
                                    <td style={{border: '1px solid #000', padding: '5px', width: '50%'}}>
                                ...
                                <tr>
                                    ...
                                    <td style={{border: '1px solid #000', padding: '5px', textAlign: 'left', width: '50%'}}>
                                        {MovingBackToIndia ? VisaValidDate ?  moment(VisaValidDate).format(CommonConfig.dateFormat.dateOnly) : '' : NAText}
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                ...
                <div class="signature-box">
                    ...
                    <div class="sign">
                        <div className= "payable-radio-common">
                            <RadioGroup aria-label="Status" name="Status" value={SignType} row 
                            onChange={(e) => this.handleCommonRadio(e)}
                            >
                                <FormControlLabel value="Esign" control={<Radio />} label="Esign" />
                                <FormControlLabel value="Type" control={<Radio />} label="Type" />
                            </RadioGroup>
                        </div>
                        {SignType === 'Type' ? 
                          <input className="signpad-input" value = {this.state.signname} onChange = { (e) => this.nameSignChange(e)} maxlength="10"/>
                          : 
                        ...
                        <span>
                          ...
                          <Button color="primary" onClick={() => this.trim()}>Submit</Button>
                        </span>
                        <div id='canvas-div' 
                          style={{display :  'none',width: 230, height: 150}}
                        >
                          <canvas className ="canvas-outline"  id='textCanvas'>
                          </canvas>
                        </div>
                ...
                <div id= {InsuranceWaiver === "Yes" ? "footer-5" : "footer-4"} class="footer">
                    <div class="f-box">
                    </div>
                    <div class="f-box-middle">
                        <b>SFL WORLDWIDE LLC | FMC License No.: 025184</b>
                    ...
                    <div class="f-box right">
                        <span>Page <b>{InsuranceWaiver === "Yes" ? 5 : 4}</b> of <b>{outofPageCount}</b></span>
                    </div>
                </div>
              ...
              >
                ...
                <DialogActions>
                  ...
                  {!this.state.hideIntital && this.state.ShowContra ?
                    <Button onClick={() => this.saveSign ()} color="primary" autoFocus>
                      Save
                    </Button>
                  :
                    null
          ...
          <div className="contract-expire-outer">
            <a href="https://www.sflworldwide.com/" target="_blank"><img src="https://hubapi.sflworldwide.com:4443/SFL_logo_white.png" /></a>
            <div className="ct-expire-box">
              ...
              <p className="mb-0"><a href={`mailto:`+ManagedByEmail}>{ManagedByEmail}</a></p>
          ...
          <div className="contract-expire-outer">
            ...
            <div className="ct-expire-box">
              ...
              <p>This Contract is signed successfully on {SignDate}. Please check you email for copy of signed contract.</p>
              <p>For more information please contact :</p>
              <p className="mb-0">{ManagedByName}</p>
              <p className="mb-0"><a href={`mailto:`+ManagedByEmail}>{ManagedByEmail}</a></p>
              <p>{SFLContactNumber}</p>
